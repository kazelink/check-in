...
const SVG_PLUS = '<svg viewBox="0 0 24 24"><path d="M11 11V5h2v6h6v2h-6v6h-2v-6H5v-2z"/></svg>';
const SVG_CLOSE = '<svg viewBox="0 0 24 24"><path d="M12 10.586l4.95-4.95 1.414 1.414-4.95 4.95 4.95 4.95-1.414 1.414-4.95-4.95-4.95 4.95-1.414-1.414 4.95-4.95-4.95-4.95L7.05 5.636z"/></svg>';

function toggleAdd(show) {
  $('addForm').style.display = show ? '' : 'none';
  $('addTog').innerHTML = show ? SVG_CLOSE : SVG_PLUS;
